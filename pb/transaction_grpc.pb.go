...
const (
	TransactionService_GetTransactions_FullMethodName = "/pb.TransactionService/GetTransactions"
)
...
//
// The TransactionService provides methods for managing transactions.
